...
namespace ProcessVlive
{
    ...
    public class Packet : System.Web.Services.WebService
    {
        ...
        {
            string PrefixFileName_Log = "_PACKET_MO_MT_Log";
            int Result = 400;
            string ResultDesc = string.Empty;
            string MediaID = string.Empty;
            string LinkDownload = string.Empty;
            string Message = "Vlive Link Tai Goi Media ";
            int ResultSendMT = 0;
            ...
            try
            {
                ...
                #region MyRegion
                if (!MyLocalConfig.AnalyseMO(msgbody, ref MediaID, MyLocalConfig.PacketKeyword))
                {
                ...
                //mtseq, moid, moseq, src, dest, cmdcode, msgbody, msgtype, msgtitle, mttotalseg, mtseqref, CPID, serviceid, reqtime, procresult, UserName, Password

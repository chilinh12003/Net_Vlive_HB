...
{
    /// <summary>
    /// Summary description for Ringtone
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    public class Ringtone : System.Web.Services.WebService
    {
        ...
        {
            string PrefixFileName_Log = "_Ringtone_MO_MT_Log";
            int Result = 400;
            string ResultDesc = string.Empty;
            string MediaID = string.Empty;
            string LinkDownload = string.Empty;
            string Message = "Vlive Link Tai Nhac Chuong ";
            int ResultSendMT = 0;
            ...
            try
            {
                ...
                #region MyRegion
                if (!MyLocalConfig.AnalyseMO(msgbody, ref MediaID, MyLocalConfig.RingtoneKeyword))
                {

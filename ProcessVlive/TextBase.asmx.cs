...
{
    /// <summary>
    /// Summary description for TextBase
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    public class TextBase : System.Web.Services.WebService
    {
        ...
        {
            string PrefixFileName_Log = "_TextBase_MO_MT_Log";
            int Result = 400;
            ...
            try
            {
                ...
                #region MyRegion
                if (!MyLocalConfig.AnalyseMO(msgbody, ref MediaID, MyLocalConfig.TextBaseKeyword))
                {
                ...
                SMSText = mGetContent.GetTextBase();

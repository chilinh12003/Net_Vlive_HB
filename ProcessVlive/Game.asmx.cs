...
namespace ProcessVlive
{
    ...
    public class Game : System.Web.Services.WebService
    {
        ...
        {
            string PrefixFileName_Log = "_Game_MO_MT_Log";
            int Result = 400;
            string ResultDesc = string.Empty;
            string MediaID = string.Empty;
            string LinkDownload = string.Empty;
            string Message = "Vlive Link Tai Game ";
            int ResultSendMT = 0;
            ...
            try
            {
                ...
                #region MyRegion
                if (!MyLocalConfig.AnalyseMO(msgbody, ref MediaID,MyLocalConfig.GameKeyWord))
                {

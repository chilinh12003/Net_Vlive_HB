...
namespace ProcessVlive
{
    ...
    public class Image : System.Web.Services.WebService
    {
        ...
        {
            string PrefixFileName_Log = "_Image_MO_MT_Log";
            int Result = 400;
            string ResultDesc = string.Empty;
            string MediaID = string.Empty;
            string LinkDownload = string.Empty;
            string Message = "Vlive Link Tai Hinh Anh ";
            int ResultSendMT = 0;
            ...
            try
            {
                ...
                #region MyRegion
                if (!MyLocalConfig.AnalyseMO(msgbody, ref MediaID, MyLocalConfig.ImageKeyword))
                {

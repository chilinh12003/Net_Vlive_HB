<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_GenerationXML.aspx.cs" Inherits="MyAdmin.Admin_Vlive.Ad_GenerationXML" %>
    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_4" CommandArgument="GenDate ASC" OnClick="lbtn_Sort_Click">Ngày xuất XML</asp:LinkButton>
                </th>
                <th>
                    Xem tin
                </th>
            ...
            <asp:Repeater runat="server" ID="rpt_Data">
                <ItemTemplate>
                    <tr class="Table_Row_1">
                        ...
                        <td>
                            <img src="<%#(((bool)Eval("IsCreateXML"))?"../Images/Buttons/Active_Grid.png":"../Images/Buttons/UnActive_Grid.png") %>" />
                        </td>
                        <td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cph_Javascript" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function EditData()
        {
            if (BeforeEditData())
            {
                document.location = '../Admin_Vlive/Ad_GenerationXML_Edit.aspx?ID=' + hid_ListCheckAll.value;
